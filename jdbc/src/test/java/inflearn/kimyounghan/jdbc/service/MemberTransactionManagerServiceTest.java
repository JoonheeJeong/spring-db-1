...
class MemberTransactionManagerServiceTest {
    ...
    private final MemberTransactionManagerService memberTransactionManagerService = new MemberTransactionManagerService(
    ...
    void whenValidMembers_thenPass() throws SQLException {
        ...
        // when
        memberTransactionManagerService.accountTransfer(memberA.getMemberId(), memberB.getMemberId(), 2000);
    ...
    void whenInvalidMember_thenThrow() throws SQLException {
        ...
        Assertions.assertThatThrownBy(() ->
                        memberTransactionManagerService.accountTransfer(memberA.getMemberId(), memberEx.getMemberId(), 2000))
